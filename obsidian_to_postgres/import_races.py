...
class Races:
    def __init__(self, db_config_path):
        """
        Initialize the Races class with database connection parameters.
...
if __name__ == "__main__":
    ...
    races = Races(db_config_path)
    df = races.process_markdown_files_in_directory(directory_path)
    print(df)
    races.save_to_postgresql(df, table_name)
